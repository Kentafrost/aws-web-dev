    ...
    <div class="container">
        ...
        if (!empty($mediaFiles)) {
            ...
            if ($imageCount > 0) {
                ...
                echo "<h4 style='margin: 0 0 10px 0; color: #155724;'>🖼️ Enhanced Image Viewing Available!</h4>";
            ...
            foreach ($mediaFiles as $index => $media) {
                ...
                if ($media['type'] === 'video') {
                    ...
                    // Regular video link
                    echo "<a href='{$media['webPath']}' target='_blank' style='background: #007bff; color: white; padding: 8px 16px; border-radius: 4px; text-decoration: none;'>🎬 Open Video</a>";
                    echo "</div>";
                    echo "</div>";
        ...
        <div id="help-modal" style="display: none; position: fixed; z-index: 2000; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8);">
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 30px; border-radius: 10px; max-width: 500px; width: 90%;">
                <h3 style="margin-top: 0; color: #333;">🖼️ Image Viewer Controls</h3>
                <div style="line-height: 1.6; color: #666;">
                    <strong>Navigation:</strong><br>
                    • <kbd>←</kbd> <kbd>→</kbd> Arrow keys to navigate images<br>
                    • Click navigation arrows or use mouse wheel<br><br>
                    
                    <strong>Zoom & Pan:</strong><br>
                    • Click image to zoom in/out<br>
                    • <kbd>+</kbd> <kbd>-</kbd> keys to zoom in/out<br>
                    • <kbd>0</kbd> to reset zoom<br>
                    • Mouse wheel to zoom<br>
                    • Drag to pan when zoomed<br><br>
                    
                    <strong>Other Controls:</strong><br>
                    • <kbd>Esc</kbd> to close viewer<br>
                    • <kbd>F</kbd> for fullscreen<br>
                    • Click outside image to close<br>
                </div>
