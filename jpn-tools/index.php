...
<body>
    <div class="container">
        ...
        <form id="questionForm">
            ...
            <div class="form-group">        
                <label for="question2">What is your preferred climate in your country?</label>
                <input type="range" id="question3" name="climate" min="0" max="30" required>
            </div>
    ...
    <script>
        ...
        async function loadCountries() {
            try {
                ...
                // listing up all countries for question0 "where are you from"
                const select = document.getElementById('question0');
